...
#define REGION_TEST_LEFT_EXCLUSIVE (1 << 0) //左排除测试
#define REGION_TEST_RIGHT_EXCLUSIVE (1 << 1) //右排除测试
#define REGION_TEST_SHARED (1 << 2) //相交测试
#define REGION_TEST_ALL \ 
    (REGION_TEST_LEFT_EXCLUSIVE | REGION_TEST_RIGHT_EXCLUSIVE | REGION_TEST_SHARED) //全测试
