...
typedef enum SpiceMouseMode {
    SPICE_MOUSE_MODE_SERVER = (1 << 0), //服务端鼠标模式
    SPICE_MOUSE_MODE_CLIENT = (1 << 1), //客户端鼠标模式

    SPICE_MOUSE_MODE_MASK = 0x3 //模式掩码
} SpiceMouseMode;
...
typedef enum SpiceImageType {
    SPICE_IMAGE_TYPE_BITMAP, //QXL下发的图像类型
    SPICE_IMAGE_TYPE_QUIC, //QXL下发的图像类型
    SPICE_IMAGE_TYPE_RESERVED,
    SPICE_IMAGE_TYPE_LZ_PLT = 100,
    SPICE_IMAGE_TYPE_LZ_RGB,
    SPICE_IMAGE_TYPE_GLZ_RGB,
    SPICE_IMAGE_TYPE_FROM_CACHE,
    SPICE_IMAGE_TYPE_SURFACE, //QXL下发的图像类型
...
typedef enum SpiceImageFlags {
    SPICE_IMAGE_FLAGS_CACHE_ME = (1 << 0), //缓存图像，要求缓存起来
    SPICE_IMAGE_FLAGS_HIGH_BITS_SET = (1 << 1), //32位RGB图像，alpha通道值都为0xFF
    SPICE_IMAGE_FLAGS_CACHE_REPLACE_ME = (1 << 2),

    SPICE_IMAGE_FLAGS_MASK = 0x7
} SpiceImageFlags;

typedef enum SpiceBitmapFmt {//Bitmap的格式集合
...
typedef enum SpiceBitmapFlags {
    SPICE_BITMAP_FLAGS_PAL_CACHE_ME = (1 << 0), //缓存调色板
    SPICE_BITMAP_FLAGS_PAL_FROM_CACHE = (1 << 1), //CACHE调色板
    SPICE_BITMAP_FLAGS_TOP_DOWN = (1 << 2), //位图TOPDOWN布局
...
typedef enum SpiceRopd {
    SPICE_ROPD_INVERS_SRC = (1 << 0), //翻转源
    SPICE_ROPD_INVERS_BRUSH = (1 << 1), //翻转画刷
    SPICE_ROPD_INVERS_DEST = (1 << 2), //翻转目标
    SPICE_ROPD_OP_PUT = (1 << 3), //直接显示
    SPICE_ROPD_OP_OR = (1 << 4), //位或
    SPICE_ROPD_OP_AND = (1 << 5), //位与
    SPICE_ROPD_OP_XOR = (1 << 6), //位异或
    SPICE_ROPD_OP_BLACKNESS = (1 << 7), //黑化
    SPICE_ROPD_OP_WHITENESS = (1 << 8), //白化
    SPICE_ROPD_OP_INVERS = (1 << 9), //全部翻转
...
typedef enum SpiceResourceType {
    ...
    SPICE_RES_TYPE_PIXMAP, //PIXMAP资源类型，没其他的资源类型了
...
typedef enum SpiceAudioDataMode {
    SPICE_AUDIO_DATA_MODE_INVALID, //非法数据模式
    SPICE_AUDIO_DATA_MODE_RAW, //原始数据模式
    SPICE_AUDIO_DATA_MODE_CELT_0_5_1, //CELT压缩数据格式
    SPICE_AUDIO_DATA_MODE_OPUS, //OPUS压缩数据格式
...
enum {
    ...
    SPICE_MSG_MAIN_INIT,
    SPICE_MSG_MAIN_CHANNELS_LIST, //通道列表消息
...
enum {
    ...
    SPICE_MSG_DISPLAY_DRAW_COPY, //DRAW_COPY消息
    ...
    SPICE_MSG_DISPLAY_SURFACE_CREATE, //surface创建消息
    SPICE_MSG_DISPLAY_SURFACE_DESTROY, //surface销毁消息
...
enum {
    SPICE_MSG_SPICEVMC_DATA = 101, //USB映射服务端端发送的数据

    SPICE_MSG_END_SPICEVMC
};

enum {
    SPICE_MSGC_SPICEVMC_DATA = 101, //USB映射客户端发送的数据
